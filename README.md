...
Для начала нужно установить модель SAM3 (`[facebook/sam3](https://huggingface.co/facebook/sam3/tree/main)`, 
нужно зарегистрироваться и клонировать репозиторий (скачать файлы локально на компьютер)).
